...
socket.on('receiveEmoji', ({ senderId, emoji }) => {
    ...
    em.style[isP1 ? 'right' : 'left'] = '-20px'; 
    targetPfp.style.position = 'relative';
    targetPfp.appendChild(em);
